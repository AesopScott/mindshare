...
- Target runtime: supervised local role workflow; no autonomous runtime
...
- Deferred evals: executable loop, tool trajectory, real memory writes, role queue mutation, and runtime adapter checks after Build/Equip.
...
- Conditional checks: executable loop, role queue mutation, tools, runtime adapter after Build/Equip.
