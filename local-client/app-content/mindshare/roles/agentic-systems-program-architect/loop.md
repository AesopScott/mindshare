...
Continuously protect Mindshare's agentic operating architecture while roles, skills, memory, phase boundaries, and agents evolve.
...
- Scheduled: weekly review during active Mindshare agentic architecture development.

## State

Use `roles/agentic-systems-program-architect/state.json` until a richer state store is approved.
...
8. Report: state outcome, risks, approvals needed, and next skill.
9. Stop: stop at approval boundary, unresolved ambiguity, production publish, external communication, or completion.
...
- Vik uses the Mindshare foundation memory contract before writing notes.
