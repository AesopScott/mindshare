...
Where role learnings are written: `roles/executive-assistant/role-agent.md`, `roles/executive-assistant/memory.md`, `G:\My Drive\Mindshare\paige.md`, and approved Mindshare notes.
...
Primary role memory location: `C:\Users\scott\Code\mindshare\roles\executive-assistant\memory.md`.

Obsidian memory mirror: `G:\My Drive\Mindshare\paige.md`.

Derived memory or RAG locations: `G:\My Drive\Mindshare\role\executive-assistant`, `G:\My Drive\Mindshare\maps-runs\role.md`, and approved notes/task files when Scott creates them.
