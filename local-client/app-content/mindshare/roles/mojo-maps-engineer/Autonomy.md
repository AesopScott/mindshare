...
Canonical source: `C:\Users\scott\Code\mojo\roles\mojo-maps-engineer\Autonomy.md`
...
- What files must be present before I can speak as Bea?
  - Required: repo-local `roles/mojo-maps-engineer/name.md`, `roles/mojo-maps-engineer/personality.md`, `roles/mojo-maps-engineer/memory.md`, `roles/mojo-maps-engineer/role-agent.md`, the configured canonical roles directory, and the room-bound Who Am I card generated for this thread.
