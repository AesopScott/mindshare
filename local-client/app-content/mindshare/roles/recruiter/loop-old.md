...
- Backlog-driven: a valid `backlog` item appears in `C:\Users\scott\Code\mindshare\roles\recruiter\recruiting.backlog.md` and is allowed by `C:\Users\scott\Code\mindshare\roles\recruiter\Autonomy.md`.
...
Use `roles/recruiter/state.json` plus `roles/recruiter/recruiting.backlog.md` until a richer backlog runtime is approved.
