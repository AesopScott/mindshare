...
Primary memory file: `C:\Users\scott\Code\mindshare\roles\recruiter\memory.md`.
...
- Local role contract: `C:\Users\scott\Code\mindshare\roles\recruiter\role-agent.md`
- Local workflow: `C:\Users\scott\Code\mindshare\roles\recruiter\workflow.md`
- Local loop spec: `C:\Users\scott\Code\mindshare\roles\recruiter\loop.md`
- Local state file: `C:\Users\scott\Code\mindshare\roles\recruiter\state.json`
- Local personality file: `C:\Users\scott\Code\mindshare\roles\recruiter\personality.md`
- Local primary memory: `C:\Users\scott\Code\mindshare\roles\recruiter\memory.md`
...
- Obsidian role mirror: `G:\My Drive\Mindshare\role\recruiter`
- Obsidian personality mirror: `G:\My Drive\Mindshare\role\recruiter\personality.md`
...
- Treat `C:\Users\scott\Code\mindshare\roles\recruiter\memory.md` as Ana's primary role memory file.
...
- When Scott says this channel belongs to Ana, invokes Ana by name, or asks for recruiting, hiring, role creation, role review, role onboarding, role maturity, or role-to-agent guidance, read `C:\Users\scott\Code\mindshare\roles\recruiter\memory.md` after the project foundation and before giving substantive role-building recommendations.
- When Scott asks about Ana's voice, personality, speaking style, confidence, meeting behavior, or role expression, read `C:\Users\scott\Code\mindshare\roles\recruiter\personality.md` after memory and before answering.
...
| 2026-06-19 | Moved Ana's primary memory file into the local role configuration folder at `C:\Users\scott\Code\mindshare\roles\recruiter\memory.md`; kept `G:\My Drive\Mindshare\ana.md` as the Obsidian mirror. | Scott request in Ana channel. |
...
| 2026-06-19 | Created Bea / Mojo MAPS Engineer as a candidate role contract in `C:\Users\scott\Code\mojo\roles\mojo-maps-engineer`; corrected the initial draft from generic Mindshare Agentic Engineer to Mojo MAPS Engineer. | Scott correction in Ana channel. |
