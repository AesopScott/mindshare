...
### 9. First Office Invitation

When inviting a newly created or newly activated role into its office for the first time, the opening line must name the office and the person/title context: `This is <Name>'s Office. <Name> - <Autonomy Level> - <Role or Title>.`

The `This is <Name>'s Office.` declaration is required because it triggers the Who Am I card in that office session. The second sentence gives the office identity card enough human-readable context for the session. Do not rely on implied office context, thread title, role slug, or surrounding conversation.
