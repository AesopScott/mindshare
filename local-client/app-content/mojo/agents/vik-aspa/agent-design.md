...
- Role contract authority source: `roles/maps-agentic-systems-program-architect/role-agent.md`
...
- Durable role memory: `roles/maps-agentic-systems-program-architect/memory.md`.
