...
- 2026-06-21 - v0.5.0 - Made `roles/maps-agentic-systems-program-architect/Autonomy.md` the canonical human-authored autonomy contract and reduced this file to a Build compatibility pointer; activation remains blocked.
- 2026-06-21 - v0.6.0 - Recorded that Scott completed and approved the autonomy contract interview in `roles/maps-agentic-systems-program-architect/Autonomy.md`; this shim now points Build/Evaluate to the canonical answers and keeps activation blocked.
...
- Canonical autonomy source: `roles/maps-agentic-systems-program-architect/Autonomy.md`
...
Build, Equip, Evaluate, Deploy, Observe, and runtime adapters must read `roles/maps-agentic-systems-program-architect/Autonomy.md` as the canonical autonomy source.

## Scott Contract Answers

The approved answers live in `roles/maps-agentic-systems-program-architect/Autonomy.md` under `Approved Contract Answers`. This table is a compatibility index only. Missing or conflicting authority must not be inferred from role seniority, prior conversation, heartbeat behavior, architectural preference, tool access, file access, or gate access.
...
Any MAPS phase or runtime code that reads this file must immediately follow the canonical pointer to `roles/maps-agentic-systems-program-architect/Autonomy.md`.

If `roles/maps-agentic-systems-program-architect/Autonomy.md` is missing, unreadable, or inconsistent with this shim, autonomy-related Build, Equip, Evaluate, Deploy, Observe, or runtime work must fail closed and ask Scott for direction.
