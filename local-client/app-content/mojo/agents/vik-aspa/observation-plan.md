...
```json
{
  ...
  "inputs": {
    ...
    "source_hashes": {
      "role_agent": "<SHA256 of roles/maps-agentic-systems-program-architect/role-agent.md>",
      "autonomy": "<SHA256 of roles/maps-agentic-systems-program-architect/Autonomy.md>",
