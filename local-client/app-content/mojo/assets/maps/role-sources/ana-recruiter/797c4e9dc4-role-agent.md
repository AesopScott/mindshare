...
Personality profile source: `C:\Users\scott\Code\mindshare\roles\recruiter\personality.md`.

Personality mirror source: `G:\My Drive\Mindshare\role\recruiter\personality.md`.
...
Runtime or surface: `AGENTS.md`, `roles/recruiter/`, `/role`, Obsidian role notes, and future role queue.
...
Where role learnings are written: `roles/recruiter/role-agent.md`, `roles/recruiter/memory.md`, `roles/recruiter/state.json`, `G:\My Drive\Mindshare\ana.md`, `G:\My Drive\Mindshare\maps-runs\role-ana-recruiter.md`, and approved Obsidian notes.
...
Memory update: write primary Ana role memory to `roles/recruiter/memory.md`, mirror durable memory changes to `G:\My Drive\Mindshare\ana.md`, write MAPS run notes through the MAPS helper to `G:\My Drive\Mindshare\maps-runs`, and mirror role artifacts under `G:\My Drive\Mindshare\role\recruiter`.
...
Derived memory or RAG locations: `G:\My Drive\Mindshare\maps-runs\role-ana-recruiter.md`, `G:\My Drive\Mindshare\role\recruiter`, `G:\My Drive\Mindshare\ana.md`, and `.maps\rag-updates.json`.
...
Output: `roles/recruiter/role-agent.md`

Memory updates: Role contract, workflow, draft skill, loop, and state mirrored to `G:\My Drive\Mindshare\role\recruiter`; shared MAPS memory helper records durable note and RAG update manifest.
