...
- `liz-handoff-check` runs as a deterministic file-watch every minute.
- It may read Liz's assigned handoff files, `G:\My Drive\Mindshare\channels\training.md`, `C:\Users\scott\Code\mindshare\roles\autonomy-engineer\Autonomy Evaluation 1.md`, `C:\Users\scott\Code\mojo\maps\org-chart\index.html`, `G:\My Drive\Mindshare\roles.md`, and the Mindshare Obsidian content-file snapshot when concrete changed-file work requires it and Liz is not engaged in active user-directed work.
- It may compare `.md`, `.canvas`, and `.json` files under `G:\My Drive\Mindshare` against `G:\My Drive\Mojo\role\mojo-website-manager\obsidian-file-index.json`, excluding Obsidian app internals such as `.obsidian` and `.trash`.
...
- For org-chart autonomy updates, read `C:\Users\scott\Code\mindshare\roles\autonomy-engineer\Autonomy Evaluation 1.md` in full when that file changes; compare its current levels, ignoring future/pending levels, against `C:\Users\scott\Code\mojo\maps\org-chart\index.html` visible labels and CSS classes.
...
- Creating file watchers or monitors that continuously inspect Obsidian writes outside the approved 1-minute deterministic file-watch snapshot
...
- `C:\Users\scott\Code\mojo\roles\mojo-website-manager\memory.md`
- `G:\My Drive\Mojo\role\mojo-website-manager\state.json`
- `G:\My Drive\Mojo\role\mojo-website-manager\obsidian-file-index.json`
...
- 2026-06-19: Moved Liz's active role memory to the repo-local `roles/mojo-website-manager/memory.md` pattern.
