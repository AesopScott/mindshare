...
- 2026-06-19 - v0.1.0 - Created ASPA profile from `roles/maps-agentic-systems-program-architect/role-agent.md` through `/define-agent`.
...
- Source role memory: `roles/maps-agentic-systems-program-architect/memory.md`
...
- Read and update `roles/maps-agentic-systems-program-architect/memory.md` for Vik durable operating memory.
...
- Primary memory location: `roles/maps-agentic-systems-program-architect/memory.md`
