...
- Claude CLI wrapper: `C:\Users\scott\Code\mojo\scripts\invoke-claude-low-token.ps1`\n- Level 4 backlog-research script: `C:\Users\scott\Code\mojo\roles\maps-agentic-systems-program-architect\scripts\level4automation.py`
- Level 5 product-recommendation script: `C:\Users\scott\Code\mojo\roles\maps-agentic-systems-program-architect\scripts\level5automation.py`
...
- Validate queue/backlog/report alignment with `C:\Users\scott\Code\mojo\scripts\check-vik-backlog-integrity.ps1` after any Vik backlog status, queue state, or completion report change.\n- Validate Level 4 backlog detection, queue-state alignment, next eligible item, source conflicts, and state/proof with `C:\Users\scott\Code\mojo\roles\maps-agentic-systems-program-architect\scripts\level4automation.py` after any Vik backlog, queue-state, completion report, or automation prompt change.
- Validate Level 5 recommendation inventory, active/inactive gate, state/proof, and source-conflict status with `C:\Users\scott\Code\mojo\roles\maps-agentic-systems-program-architect\scripts\level5automation.py` after any Vik Level 5 report, policy, state, proof, or automation prompt change.
...
- `vik-visible-backlog-research` calls `C:\Users\scott\Code\mojo\roles\maps-agentic-systems-program-architect\scripts\level4automation.py --write --mode scheduled` before Level 4 research checks. The script owns deterministic backlog counts, queue/backlog alignment, eligible-item detection, source-conflict proof, state, and proof; the heartbeat owns live role context, Claude research execution, visible reporting, and owner routing.\n- `vik-visible-backlog-research` calls `C:\Users\scott\Code\mojo\roles\maps-agentic-systems-program-architect\scripts\level5automation.py --write --mode scheduled` before Level 5 checks. The script owns deterministic Level 5 inventory and source-conflict proof; the heartbeat owns live role context and visible reporting.
