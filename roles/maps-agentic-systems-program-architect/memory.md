...
- MAPS Management Team is the Mojo management grouping for Vik / ASPA, Cal / MAPS ASPM, Bea / Mojo MAPS Engineer, and Lane / Mojo Lab Operator. Cal, Bea, and Lane report to Vik for MAPS management structure. Matt is released legacy context, not the active MAPS ASPM.
...
- Repo-local role memory at `C:\Users\scott\Code\mojo\roles\maps-agentic-systems-program-architect\memory.md` is Vik's active working memory.
