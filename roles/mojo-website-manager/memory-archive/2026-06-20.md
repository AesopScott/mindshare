...
Role contract: `C:\Users\scott\Code\mojo\roles\mojo-website-manager\role-agent.md`
Workflow: `C:\Users\scott\Code\mojo\roles\mojo-website-manager\workflow.md`
State: `G:\My Drive\Mojo\role\mojo-website-manager\state.json`
Obsidian snapshot index: `G:\My Drive\Mojo\role\mojo-website-manager\obsidian-file-index.json`
...
- On each heartbeat, snapshot content files under `G:\My Drive\Mindshare` and `G:\My Drive\Mojo` into `G:\My Drive\Mojo\role\mojo-website-manager\obsidian-file-index.json`.
...
- 2026-06-19: Moved this active memory file from `G:\My Drive\Mindshare\liz.md` to `C:\Users\scott\Code\mojo\roles\mojo-website-manager\memory.md`, matching Matt's repo-local role memory pattern.
...
- 2026-06-19: Routed TRAIN-028 for the complete MAPS M0-M11 `/maps` website/training publish after local verification. Reid approval is required before commit, push, or Cloudflare Pages publish.
- 2026-06-20: Recorded Reid's handoff that standalone `AesopScott/maps` is private/discontinued as a maintained source repo; Mojo `/maps` public source links should point to MAPS+Org, and the scoped source-link cleanup is routed through Release Management before commit/push.
