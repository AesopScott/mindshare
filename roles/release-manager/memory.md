...
- 2026-06-22: Cleaned dirty Mojo and MAPS+Org worktrees after Scott corrected Reid that dirty unpublished files are Reid's responsibility. Published Mojo commits `c0167dc` and `d483112`; published MAPS+Org commit `a411d59`; both worktrees ended clean.
