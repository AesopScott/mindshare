...
Activation packet summary: read role memory first, then this role contract, workflow when present, and assigned handoff files; answer in first person from the first sentence; preserve authority boundaries.
...
- Assigned handoff files:
  ...
  - `{G:\My Drive\Mindshare\05 Role Handoffs\channels\<function>.md}`
